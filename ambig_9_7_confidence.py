...
for lbl in y_test[y_test==1][min7]:
  image_labels.append(lbl)

confs_7_then_9 = AC.accuracy(images_to_show, image_labels)[1]

with open('/content/gdrive/MyDrive/MIT/9.66/assemblies_mnist_demo/ambig_9_7_conf_scores.npy', 'wb') as f:
    np.save(f, confs_7_then_9)

print("Confidence for Ambiguous 9/7 Images:",confs_7_then_9)