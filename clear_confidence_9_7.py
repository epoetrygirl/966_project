...
conf7 = AC.accuracy(x_test_all[clear_7], y_test_all[clear_7])[1]
conf9 = AC.accuracy(x_test_all[clear_9], y_test_all[clear_9])[1]

with open('/content/gdrive/MyDrive/MIT/9.66/assemblies_mnist_demo/clear_conf_scores_7.npy', 'wb') as f:
    np.save(f, conf7)

with open('/content/gdrive/MyDrive/MIT/9.66/assemblies_mnist_demo/clear_conf_scores_9_7.npy', 'wb') as g:
    np.save(g, conf9)

print("Confidence for 7:",conf7)
