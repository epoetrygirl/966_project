...
def create_binary_dataset(stim_size, support, N):
    ...
    return np.vstack((X1, X2))[p], np.concatenate([np.zeros(N), np.ones(N)])[p]
...
if __name__ == "__main__":
    ...
    writepath = '/content/gdrive/MyDrive/MIT/9.66/assemblies_mnist_demo/results_shuffled_P_X_te_conf.npy'
    with open(writepath, 'wb') as f:
        np.save(f,P_X_te_conf)
    writepath = '/content/gdrive/MyDrive/MIT/9.66/assemblies_mnist_demo/results_shuffled_Q_X_te_conf.npy'
    with open(writepath, 'wb') as f:
        np.save(f,Q_X_te_conf)
    writepath = '/content/gdrive/MyDrive/MIT/9.66/assemblies_mnist_demo/results_shuffled_QQ_X_te_conf.npy'
    with open(writepath, 'wb') as f:
        np.save(f,QQ_X_te_conf)

    writepath = '/content/gdrive/MyDrive/MIT/9.66/assemblies_mnist_demo/results_shuffled_test_data.npy'
